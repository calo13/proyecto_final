...
<br><br><br>
      <h1 class="text-center" style="color: black;">EVALUACIONES IAC</h1>

<div class="row justify-content-center">
    <div id="tablaCandidatoContainer" class="col table-responsive" style="max-width: 85%; padding: 10px; margin-left: 60px; margin-top: 1px;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" name="guardarConclusiónBtn" id="guardarConclusiónBtn">Guardar</button>
      </div>
    </div>
  </div>
</div>

<script src="<?= asset('./build/js/evaluacion/iac.js')  ?>"></script>
