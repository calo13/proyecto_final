...
const datatable = new Datatable('#tablaCandidato', {
    ...
    columns: [
        ...
        className: 'text-center',
            ...
            searchable: false,
            orderable: false,
            render: (data, type, row, meta) => `<button class="btn btn-info" data-toggle="modal" data-target="#miModal" data-ruta='/proyecto_final/verrespuesta/epqa?nuevoCandidatoID=${data}'>Ver</button>`
        },            
        {
            className: 'text-center',
            width: '50px',
            ...
            searchable: false,
            orderable: false,
            render: (data, type, row, meta) => `<button class="btn btn-primary" data-toggle="modal" data-target="#miModal" data-ruta='/proyecto_final/verresultado/epqa?nuevoCandidatoID=${data}'>Ver</button>`
        },
        {
            className: 'text-center',
            width: '150px',
...
const buscar = async () => {
    const url = `/proyecto_final/API/evaluacion/buscar/epqa`;
    const config = {
        method: 'GET'
    };
