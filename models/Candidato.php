...
class Candidato extends ActiveRecord
{
    ...
    protected static $columnasDB = ['cand_primer_nombre', 'cand_segundo_nombre','cand_dpi', 'cand_primer_apellido', 'cand_segundo_apellido', 'cand_sexo', 'cand_fecha_nacimiento', 'cand_fecha_evaluacion_terminada', 'cand_time', 'cand_centro', 'cand_estado', 'cand_conclusion', 'cand_test_id', 'cand_situacion'];
